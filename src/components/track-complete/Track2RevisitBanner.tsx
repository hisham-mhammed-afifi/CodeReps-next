...
export function Track2RevisitBanner() {
  return (
    <motion.div
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            All 15 DOM challenges are open for re-attempt in any mode — Guided,
            Semi-Guided, and Independent. Your original completion data stays
            intact.
          </p>
          <Link
